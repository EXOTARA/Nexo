...
public sealed class NaturalCommandParserTests
{
    ...
    [InlineData("Sakura, cómo está mi PC", LocalCommandType.ShowSystemStatus)]
    [InlineData("Oye Sakura, cómo está mi PC", LocalCommandType.ShowSystemStatus)]
    ...
    {
        var normalized = NaturalCommandParser.Normalize("¡Sakura, cómo está mi PC?");

        Assert.Equal("sakura como esta mi pc", normalized);
    }
}
