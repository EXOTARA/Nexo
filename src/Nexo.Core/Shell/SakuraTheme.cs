...
public sealed record SakuraTheme(string Id, string DisplayName, string Description, string AccentHex);

public static class SakuraThemeCatalog
{
    public static readonly IReadOnlyList<SakuraTheme> All =
    [
        new("sakura", "Sakura", "El look clásico de Sakura desde el primer día.", "#8B6CFF"),
    ...
    /// </summary>
    public static SakuraTheme? FindByAccent(string accentHex) =>
