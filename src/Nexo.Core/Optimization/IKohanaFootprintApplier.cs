...
/// <summary>
/// Diseño D11 (Fase 4) — el segundo objetivo que Kohana aplica de verdad: su PROPIO consumo.
///
...
/// con certeza. El modo de rendimiento de Kohana cumple las dos cosas a la vez: es un cambio real
/// que se nota en el equipo (los motores locales de voz e IA son lo más caro que corre aquí) y vive
/// en el archivo de preferencias de Kohana, así que revertirlo es escribir el valor anterior. Cero
/// riesgo de dejar Windows en un estado raro.
///
/// Es además el cambio más honesto que Kohana puede ofrecer: antes de pedirle al usuario que cierre
/// sus programas, la aplicación que se aparta primero es ella.
/// </summary>
public interface IKohanaFootprintApplier
{
